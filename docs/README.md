...
| **zsh-users+fast**, | [z-shell/F-Sy-H](https://github.com/z-shell/F-Sy-H), [zsh-users/zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions), [zsh-users/zsh-completions](https://github.com/zsh-users/zsh-completions)                                                                                                                                                                                                                                                                      |
|                     |
|     **z-shell**     | [z-shell/F-Sy-H](https://github.com/z-shell/F-Sy-H), [z-shell/H-S-MW](https://github.com/z-shell/H-S-MW), [z-shell/zsh-diff-so-fancy](https://github.com/z-shell/zsh-diff-so-fancy)                                                                                                                                                                                                                                                                                                    |
